...
60 bài mỗi level. App này 4 level / 70 bài — ít bài hơn đáng kể, xem mục "Giới hạn đã biết".

---

## L1 — Bậc khởi động (Pre-A1)

**10 bài:** S01 S02 S03 S04 S06 S07 · F01 F02 F03 F04 · **~4 tuần**

Sáu bài sinh tồn trước: bảng chữ cái và đánh vần tên, số đếm và cặp -teen/-ty, giờ và thứ,
ba câu cứu hộ khi chưa hiểu, chào hỏi và tạm biệt, bốn cụm lịch sự. Rồi bốn âm mà tiếng Việt không có hoặc hay nuốt: /θ/–/ð/,
...
**12 bài:** S05 S08 · F05 F06 F07 F08 CP-F · D01 D02 D03 D04 CP-D · **~5 tuần**

Giới thiệu bản thân, nhờ và xin phép. Trọng âm từ, ba động từ lõi (be/have/do), câu hỏi Wh-,
câu hỏi lại khi chưa hiểu. Rồi bốn tình huống
...
**70/70 bài** có đủ Nghe · Nói · Đọc · Viết, cả bốn bậc. Tuyên bố đầu ra ở trên là thật và kiểm
...
Audio cũng tăng dần theo bậc: **Pre-A1 0.85 · A1 0.9 · A2 1.0 · B1 1.1**.

Trước bản này ba chỗ trong bộ sinh audio hardcode `0.85 nếu phase là foundation, còn lại 1.0` —
theo *phase* chứ không theo *bậc*. Hậu quả: F18–F20 (bậc B1) đọc chậm 0.85, chậm hơn cả bài A2, và
**toàn bộ bậc B1 không bao giờ vượt 1.0**. Mục tiêu sản phẩm là standup và call với khách nước ngoài,
nơi người ta nói nhanh hơn thế — học viên thạo hết ở 1.0 vẫn đứng hình trong cuộc gọi thật.

## Giới hạn đã biết

1. **Nền L1 dừng ở 10 bài** (kế hoạch nhắm 12), L2 ở 12 (nhắm 14). Bốn bài thêm vào là bốn chủ đề
   người mất gốc thật sự thiếu trong ngày đầu; thêm nữa chỉ để tròn số là độn, không phải nội dung
   họ cần. VUS 60 bài/level, Ms Hoa ~14 buổi/level — vẫn ít hơn đáng kể.
2. **Checkpoint gắn với *phase*, không gắn với *level*.** Chúng đã đo đủ bốn kỹ năng và có ngưỡng
   riêng từng kỹ năng, nhưng phạm vi vẫn theo chủ đề. Trang lộ trình bù bằng mục **Tiến độ theo bậc** —
   một bản đọc trung thực từ điểm đã có, không phải bài kiểm tra mới.
3. **Bộ luyện viết ở `/learn/write`** (14 bài, 3 bộ) không tính vào mastery. Nó đã được sắp theo bậc
   và đánh dấu bộ vượt trình độ, nhưng vẫn là phần luyện thêm nằm cạnh lộ trình chứ không nằm trong.
