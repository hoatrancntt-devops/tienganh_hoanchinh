...
**Trạng thái:** Toàn bộ 8 phase đã xong và đã deploy
...
| 07 Dày nền mất gốc | ✅ **L1 4→10, L2 10→12** (S01–S08). Dừng ở 10/12 có chủ ý — xem docs/khung-level.md |
...
2. ~~Ngưỡng mastery giảm dần khi bài khó lên — chủ ý hay trôi dạt?~~ **Đã trả lời 2026-07-21:**
   trôi dạt. Đo lại thì ngưỡng không phải đường cong nào cả, chỉ là 70/75/78 rải ngẫu nhiên, và ở
   chỗ quan trọng nhất thì ngược. Đã đặt lại thành 70 → 73 → 76 → 80 theo bậc; xem `docs/khung-level.md`.
3. ~~Ngưỡng phát âm ≥78 khắt khe hơn chuẩn CEFR ở bậc A1–A2 — giữ hay hạ?~~ **Đã trả lời 2026-07-21:**
   hạ, cùng với câu 2. Bậc Pre-A1 còn 70. Giữ nguyên `min_speaking_attempts` để vẫn bắt buộc luyện.
